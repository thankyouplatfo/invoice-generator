...
@section('content')
    ...
    @endif
    <form class="w3-row-padding" action="{{ route('customers.store') }}" method="post">
        @csrf
        ...
        <p class="py-2 w3-col l4 w3-right">
            ...
            <input class="w3-input phone" name="phone" id="phone" value="{{ old('phone') }}" type="text">
            @error('phone')
                <b class="err">{{ $message }}</b>                
            @enderror
        </p>
        ...
        <p class="my-3 w3-col">
            <input class="w3-button w3-left w3-blue w3-large" type="submit" value="إنشاء عميل">
        </p>
    </form>
@endsection
